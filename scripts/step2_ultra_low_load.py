#!/usr/bin/env python3
"""
Step 2 Method Comparison - ULTRA LOW LOAD VERSION
RPS_SCALING = 1 (~0.27 req/s) for arrival rate comparison.
"""
...
# Output paths
RESULTS_DIR = os.path.join(os.path.dirname(__file__), '..', 'stress_test_ultra_low_load')
...
# ULTRA LOW LOAD: 1x scaling (~0.27 req/s)
RPS_SCALING = 1.0
...
def main():
    ...
    print("=" * 70)
    print("STEP 2: Method Comparison (ULTRA LOW LOAD)")
    print("=" * 70)
